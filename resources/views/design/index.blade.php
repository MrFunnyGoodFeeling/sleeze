            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="space-y-4">
                    <div class="flex space-x-4">
                        <button type="button" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Save
                        </button>
                        <button type="button" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:bg-gray-50">
                            Change
                        </button>
                    </div>
                    <div class="flex space-x-4">
                            ...
                            <tr>
                                ...
                                <td class="py-1 px-6">
                                    <div class="flex space-x-2">
                                        <button class="rounded-md bg-gray-950/5 px-2.5 py-1.5 text-sm font-semibold text-gray-900 transition-all duration-300 hover:bg-gray-950/10">
                                            Change
                                        </button>
                                    </div>
                                </td>
